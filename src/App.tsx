            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg transform hover:-translate-y-2 transition-transform duration-300">
                    <Code className="h-8 w-8 text-indigo-600 mb-3" />
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Frontend Dev</h3>
                    <p className="text-gray-600 dark:text-gray-300">React, TypeScript, Tailwind</p>
                  </div>
                  <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg transform hover:-translate-y-2 transition-transform duration-300">
                    <Monitor className="h-8 w-8 text-green-600 mb-3" />
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">UI/UX</h3>
                    <p className="text-gray-600 dark:text-gray-300">Figma, User Experience</p>
                  </div>
                </div>
                <div className="space-y-4 mt-8">
                  <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg transform hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">Photo Manipulation, Flyers</p>
                  </div>
                  <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg transform hover:-translate-y-2 transition-transform duration-300">
                    <PenTool className="h-8 w-8 text-purple-600 mb-3" />
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Video Edit</h3>
                    <p className="text-gray-600 dark:text-gray-300">Motion Graphics</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="experience" className="py-20 px-4 bg-white dark:bg-gray-800">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="prose dark:prose-invert">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Problem Solver</h3>
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Experience Timeline</h2>
              <div className="space-y-8">
                <div className="relative pl-8 border-l-2 border-indigo-600">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Senior Frontend Developer</h3>
                  <p className="text-gray-600 dark:text-gray-300">Leading frontend development for enterprise applications</p>
                </div>
                <div className="relative pl-8 border-l-2 border-pink-600">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">Creating brand identities and marketing materials</p>
                </div>
                <div className="relative pl-8 border-l-2 border-purple-600">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">Building responsive web applications</p>
                </div>
                <div className="relative pl-8 border-l-2 border-green-600">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">Designing user interfaces and experiences</p>
                </div>
              </div>
            </div>
          </div>
